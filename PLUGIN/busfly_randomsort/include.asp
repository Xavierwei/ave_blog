...
Const busfly_randomsort_isBuildnew=0
	'<!--最新文章-->是否使用	
Const busfly_randomsort_isBuildrand=0
	'<!--随机文章-->是否使用	
Const busfly_randomsort_isBuildallrand=1
	'<!--完全随机文章-->是否使用	
Const busfly_randomsort_isBuildcommonth=0
	'<!--本月评论排行-->	是否使用
Const busfly_randomsort_isBuildcomyear=0
	'<!--本年评论排行-->是否使用
Const busfly_randomsort_isBuildtopmonth=0
	'<!--本月排行-->是否使用
Const busfly_randomsort_isBuildtopyear=0
	'<!--本年排行-->是否使用
Const busfly_randomsort_isBuildtophot=1
	'<!--热文排行-->	是否使用
Const busfly_randomsort_isBuildCategory=0
	'<!--分类文章-->	是否使用
	
Const busfly_randomsort_isBuildCategoryComments=0
	'<!--分类最新回复-->	是否使用
Const busfly_randomsort_isBuildCategoryTophot=0
	'<!--分类热门文章-->	是否使用
	
Const busfly_randomsort_isBuildTags=0
	'是否启用生成TAGS
Const busfly_randomsort_isStatistics=0
	'是否启用网站统计
Const busfly_randomsort_isArchives=0
	'是否启用归档
Const busfly_randomsort_isComments=0
	'是否启用评论回复
Const busfly_randomsort_isGuestComments=0
	'是否启用留言
Const busfly_randomsort_isTrackBacks=0
	'是否启用引用列表
Const busfly_randomsort_isCatalogs=0
	'是否启用分类目录
Const busfly_randomsort_isAuthors=0
	'是否启用用户列表


Const busfly_randomsort_INTCUTLEN=24
	'每条记录的标题字数
