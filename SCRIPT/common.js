...
function getCookieValueByName(name) {
    ...
    //alert("name:" + name + " start:" + start);
    var len = start + name.length + 1;

    //alert("document.cookie :" + document.cookie + "#start:" + start + "#len:" + len);
    if ((!start) &&
    ...
    //alert("name:" + name + " endflag4:" + endflag4);
    if (endflag2 <= 0) {
        endflag2 = endflag3;
    ...
    //alert(name + ":-" + document.cookie.substring(len, endflag));
    //return decodeURI(document.cookie.substring(len, endflag));
...
function LoadRememberInfo() {
    ...
    var strName = getCookieValueByName("inpName");
    var strEmail = getCookieValueByName("inpEmail");
    var strHomePage = getCookieValueByName("inpHomePage");
    var bolRemember = getCookieValueByName("chkRemember");
    ...
    if (GetCookie("username")) {
        var bbsuser = "";
        var tempbbsuser = getCookieValueByName("username");
        ...
        document.getElementById("inpName").value = bbsuser;
    }




    if (GetCookie("AveneUserEmail")) {
        document.getElementById("inpEmail").value = unescape(GetCookie("AveneUserEmail"));
    }
...
// 返回：    无
//*********************************************************
function RevertComment(intRevertID, revertName) {
    var f;
    if (objActive) {
        f = document.getElementById(objActive).form;
        var commentmsg = "回复" + revertName + "的评论:";
        $("#msg").val(commentmsg);
        //alert($("#msg").val());

        $("#" + objActive).val(commentmsg);
        //alert(commentmsg.length);
        setcursor(document.getElementById(objActive), commentmsg.length);
    }
    else {
